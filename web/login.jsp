            ...
            <div class="card bg-dark text-white" style="border-radius: 1rem; z-index: 2;">
                <div class="card-body p-5 text-center">
                    <div class="mb-md-5 mt-md-4 pb-5">
                        ...
                        <!-- 다국어 처리 필요 5 -->
                        <p class="small mb-5 pb-lg-2 script-normal"><a class="text-white-50" href="#!">비밀번호를 잊으셨습니까?</a></p>
                        <!-- 다국어 처리 필요 6 -->
                        <button class="btn btn-outline-light btn-lg px-5 script" type="submit">Login</button>
                    </div>
                    <div>
                        <!-- 다국어 처리 필요 7 -->
                        <p class="mb-0 script-normal">계정이 없으십니까?
                            <!-- 다국어 처리 필요 8 -->
                            <a href="sign_up.jsp" class="text-white-50 fw-bold script-normal">회원가입</a>
                        </p>
