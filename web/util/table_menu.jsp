...
<div class="row">
    <div class="dropdown no-arrow mb-0">
        ...
        <button class="btn btn-secondary dropdown-toggle ml-3" type="button"
                ...
                aria-expanded="false"
                style="background-color: #0e76a8; border-color: #0e76a8; width: 7rem">날짜순
        </button>
    ...
    <div class="dropdown no-arrow mb-0">
        <button class="btn btn-secondary dropdown-toggle ml-3" type="button"
                id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false"
                style="background: #6b35bb; border-color: #6b35bb; width: 7rem">금액순
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="dropdown no-arrow mb-0">
        <button class="btn btn-secondary dropdown-toggle ml-3" type="button"
                id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false"
                style="background: #be43c7; border-color: #be43c7; width: 7rem">카테고리별
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
