    ...
    <div class="container py-5 h-100 stop-dragging" style="z-index: 2;">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-white text-dark" style="border-radius: 1rem; z-index: 2;">
                    <div class="card-body p-5 text-center">
                        <div class="mb-md-5 mt-md-4 pb-5">
                            <h2 class="fw-bold mb-2 text-uppercase index">소비 기록 추가하기</h2>
                            <!-- 폼 태그 -->
                            <div class="form-outline form-white mb-4">
                                <label class="col-form-label script">소비일자</label>
                                <input name="expend_date" type="text" id="expend_date" class="form-control form-control-sm" readonly/>
                            </div>
